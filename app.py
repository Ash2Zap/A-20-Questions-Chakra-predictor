# app.py — Chakra Insight (Bayesian 20Q) with PDF + Logo + Crystal Links
...
REMEDIES: Dict[str, Dict[str, str]] = {
    "Root (Muladhara)": {
        ...
        "ritual": "Morning: 5-min box-breath (4-4-4-4), 10-min barefoot walk; Evening: write 3 safety wins + Ho’oponopono for 'money/safety'.",
        ...
        "link": "https://myaurabliss.com/collections/root-chakra",
    },
    "Sacral (Svadhisthana)": {
        ...
        "link": "https://myaurabliss.com/collections/sacral-chakra",
    },
    "Solar Plexus (Manipura)": {
        ...
        "ritual": "Morning: 3 rounds Breath of Fire (30s each) → 1 minute plank; Midday: choose ONE priority and finish it; Night: note 3 ways you used kind power; burn one perfection thought.",
        ...
        "link": "https://myaurabliss.com/collections/solar-plexus-chakra",
    },
    "Heart (Anahata)": {
        ...
        "oil": "Rose / Geranium",
        "mudra": "Hridaya Mudra",
        "link": "https://myaurabliss.com/collections/heart-chakra",
    },
    "Throat (Vishuddha)": {
        ...
        "mudra": "Granthi Mudra",
        "link": "https://myaurabliss.com/collections/throat-chakra",
    },
    "Third Eye (Ajna)": {
        ...
        "link": "https://myaurabliss.com/collections/third-eye-chakra",
    },
    "Crown (Sahasrara)": {
        ...
        "link": "https://myaurabliss.com/collections/crown-chakra",
    },
}
...
def expected_information_gain(current: Dict[str, float], qid: str) -> float:
    ...
    for a, pa in ans_ps.items():
        ...
        post = {}
        for c in current:
            if a == "yes": like = LIKELIHOODS[c][qid]
            elif a == "no": like = 1 - LIKELIHOODS[c][qid]
            else: like = 0.5
...
if conf >= stop_threshold or len(asked_ids) >= len(QUESTIONS):
    ...
    for name, p in ordered:
        ...
        st.caption(f"Why: {REMEDIES[name]['why']}  |  Affirmation: {REMEDIES[name]['affirm']}  |  Crystals: {REMEDIES[name]['crystal']}  |  Shop: {REMEDIES[name]['link']}")
    ...
    def generate_pdf(buf: io.BytesIO):
        ...
        c.setFont("Helvetica", 10); c.drawString(220, H-85, f"Top Insight: {winner} (confidence {conf:.0%})")
